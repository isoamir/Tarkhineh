...
const liStyle =
   "text-[#717171] text-sm lg:text-lg border-[#ffffff00] py-1 duration-500 cursor-pointer transition-colors hover:text-[#418056]";
          ...
          <ul className={ulStyle}>
            {pages.map((item) => (
              <li
                key={item.id}
                className={
                  currentPath === item.url ? liActiveStyle : liStyle
                }
              >
